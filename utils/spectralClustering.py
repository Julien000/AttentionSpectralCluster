...
class SpectralClustering:
  ...
  def __init__(self, n_clusters=2, n_neighbors=10, sigma='max', e=5, affinity='k-hNNG' , type_of_laplacian='rw',knn_aprox=False, eigen_aprox=True ,normalize=False, print_time=False):
    '''
  ...
  def to_graph(self,X,sigma,e,n_neighbors,similarity_matrix,knn_aprox=False,eps=1e-7):
    '''
